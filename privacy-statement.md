...
___Mailchimp___ data is stored in the US: Our servers and offices are located in the United States, so your information may be transferred to, stored, or processed in the United States.  Information includes email address, contact name, interest in products, purchased products and DfE number.
